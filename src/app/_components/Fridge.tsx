    ...
    <form onSubmit={handleSubmit} className="flex flex-col">
      ...
      <div className="flex flex-col gap-5 px-5 sm:px-8 pt-5 safe-pb">
        ...
        <button
          ...
          disabled={pending}
          className="inline-flex items-center justify-center gap-2 rounded-full px-4 py-2.5 text-sm font-medium transition-colors duration-150 ease-out disabled:opacity-50 min-h-[44px]"
          style={{
            background: confirmFinish ? "var(--terracotta)" : "transparent",
            color: confirmFinish ? "#ffffff" : "var(--terracotta)",
